<?php
namespace Greet\Employee\Model;
...
use Greet\Employee\Model\HamburgerFactory;
use Greet\Employee\Model\ResourceModel\Hamburger as ObjectResourceModel;
use Greet\Employee\Model\ResourceModel\Hamburger\CollectionFactory;
/**
...
class HamburgerRepository implements HamburgerRepositoryInterface
{
     ...
     *
     * @param HamburgerFactory $objectFactory
     * @param ObjectResourceModel $objectResourceModel
     * @param CollectionFactory $collectionFactory
     * @param SearchResultsInterfaceFactory $searchResultsFactory
     */
    public function __construct(
        HamburgerFactory $objectFactory,
